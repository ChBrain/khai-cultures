# Melilla: a khai culture

Melilla staged as a full khai play, ISO ES-ML, language es. Melilla: its history as the plot line, its people as the cast, the roles its 1497 taking, its Rif war and modernist boom, and its 1986 citizenship fight encode, its places, its practices, and its defining objects, all tuned by a single pitch.
...
- **Anchor:** [play_melilla.md](play_melilla.md), the culture itself.
