...
Ground when resistance hardens into mere grievance, the long memory of wrong turned to a settled bitterness that no longer builds; and ground, too, when the defiance is sold as a pose - the rebel made a brand, the fist a logo - so the real cost and courage of those who stood are flattened into swagger, and the pride that should arm the future is spent on a posture.
