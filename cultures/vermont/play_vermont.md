...
khai: play
title: "Vermont"
description: "Vermont staged: the Green Mountain State of maple sugarhouses, independent town meetings, and artisanal dairy craft."
declared: "Vermont"
language: en
...
- [Ira](persona_ira.md)
- [Emma](persona_emma.md)

**Places**

- [the Green Mountain Cabin](place_green_mountain_cabin.md)
- [the Vermont sugarhouse](place_sugarhouse_vt.md)

**Processes**

- [maple evaporation](process_maple_evaporation.md)
- [ice cream churning](process_ice_cream_churning.md)
...
- [sugarhouse evaporator](piece_sugarhouse_evaporator.md)
- [ice cream tub](piece_ice_cream_tub.md)

**Pitches**

- [the Vermont key](pitch_vermont.md)

**An operational plan**

- [the Lake Champlain plan](plan_lake_champlain_watershed_conservation.md)
