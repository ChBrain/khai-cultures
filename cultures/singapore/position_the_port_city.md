---
khai: position
title: "the Global Port-City"
declared: "the global port-city"
language: en
...
That the country stay open, connected, and useful, dealing with everyone and locking out no one; that its institutions be reliable enough that the world routes its trade through them by choice; and that it keep earning its place each year, since position is only worth what is made of it and no crossroads is guaranteed its traffic.

## Loses

Ground when openness is taken for granted and the work of staying indispensable slackens - when the city assumes the world must pass through it; and ground, too, when the outward-facing trade so dominates the nation's sense of itself that it is measured only by its throughput, and forgets the people and the home languages that the bridge tongue was meant to serve, not replace.
