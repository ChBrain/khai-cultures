# Nicaragua: a khai culture

Nicaragua staged as a full khai play, ISO NI, language es. A land of lakes and
volcanes and of poets, twice divided between the Pacific and the Caribbean, as a
theatre: its history as the plot line, its people as the cast, the roles its
language encodes, its places, its practices, and its defining objects, all tuned
by a single pitch. The play and the cast are written in Spanish; only the H2
...
- **Anchor:** [play_nicaragua.md](play_nicaragua.md), the culture itself.
...
claimed; foreign intervention, the Somoza era, and the 1979 revolution are named
soberly on the public record, without atrocity detail and without taking a
political side; the staging and the architecture are original work.
