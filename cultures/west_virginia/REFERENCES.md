...
The pitch [pitch_west_virginia.md](pitch_west_virginia.md) is written from West Virginia's profile inflected by its coal mines, mountain gaps, and white-water rivers, naming no dimension and carrying no number.

| Dimension                     | West Virginia base score (estimated / US proxy) |
| ----------------------------- | ----------------------------------------------- |
| Power Distance                | 44                                              |
| Individualism                 | 78                                              |
...
Source: Geert Hofstede, Hofstede Insights (US comparison, adjusted for West Virginia's low power distance in union locals, active local county boards, and low uncertainty avoidance in water reclamation innovation).
