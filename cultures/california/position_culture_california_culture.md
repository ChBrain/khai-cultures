---
khai: position
title: "California Culture"
declared: "California culture"
language: en
...
That one stay open to reinvention rather than settle for what one was born into, that self-fulfillment and personal growth be pursued as a matter of course, that disruption and iteration be welcomed as readily in an old craft as in a new company, and that the dreamer's optimism, whether aimed at a vineyard or a platform, be taken seriously rather than dismissed as naivety. It orders, too, that the drought and the water table be reckoned with before the next expansion is built on top of them.
...
Drives the migrations of [the Gold Rush of 1848](plot_01_gold_rush_1848.md) and the founding of [Hollywood](plot_02_hollywood_rise.md) and [Silicon Valley](plot_03_silicon_valley_boom.md) alike, each one a fresh rush chasing the same coastal promise of reinvention. It shapes the one raised in it toward restless self-invention, whether that self ends up reading the seasons in a vineyard or reading the market in a term sheet, and it drives California to hold its two rushes, the old one of soil and the new one of software, as one long story of a state that keeps betting on the next frontier even as the ground beneath it runs dry.
