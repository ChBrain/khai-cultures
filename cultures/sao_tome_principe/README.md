...
identity encode, its places, its practices, and its defining objects, all tuned
by a single pitch.
...
- **Anchor:** [play_sao_tome_principe.md](play_sao_tome_principe.md), the culture
  itself.
- **Pitch:** [pitch_pt.md](pitch_pt.md), the Hofstede layer, written from the
  islands' profile (a warm, collective, unhurried "leve-leve" register: close
  community and the lap of the island, patience and present-mindedness, modest
  display, and a quiet endurance) and naming no dimension.
- **Plots (history):** the settlement of the islands, the birth of the creole
...
claimed; the slave and forced-labour plantation past is treated soberly on the
public record, with dignity and no atrocity detail, and no political side is
taken; the staging and the architecture are original work.
