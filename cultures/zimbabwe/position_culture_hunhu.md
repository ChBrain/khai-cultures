...
That a person owes their personhood to the community that raised them and answers for more than themselves; that the elders and the ancestors are present in every matter of weight, so the chief, the sekuru, and the gogo are heard and honoured; and that the worth of any authority is measured by how it carries the weak, the young, and the bereaved, so that respect runs upward and care runs downward at once.

## Loses

Ground when the duty to the many is twisted into a burden no one can bear, or when respect for age and office hardens into silence that the young cannot break; ground, too, when the pull of the wider world teaches a person to stand alone and to reckon themselves first, forgetting that a person with no people is, in the old saying, no person at all.
