...
Ground when the cost of that freedom is softened or forgotten - the years in the bush, the hunger, the war reduced to a statue and a street name - and when the same spirit of refusal, cut from its old purpose, hardens into a bare mistrust of every order and every common effort, the unbowed neck that will not bend even where bending would build.
