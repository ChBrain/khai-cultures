...
# Plan: Pride and Industry

## Taxonomy

The charge the nation set itself in its own motto, Pride and Industry: to carry the dignity of a people who endured the plantation and made the English form their own, and to turn the industry that built the island's wealth toward a prosperity now shared by those who build it. It is the open mandate to reckon soberly with [the cradle of the plantation](position_the_cradle_of_the_plantation.md) the island gave the world, to keep the order of [Little England made its own](position_little_england_made_its_own.md) while filling it with justice, and to carry the joy of [cricket and Crop Over](position_cricket_and_crop_over.md) into the young republic without letting it stand in for the reckoning.
...
- [x] Carried from colony to independent nation in 1966, the English form filled and claimed by the people who fill it.
- [x] Set aside the crown in 2021 to become a republic, the plantation island governing itself entire.
- [x] Raised the cricketing mastery and the festival joy of Crop Over into the island's pride and the world's sight.
- [W] Reckon soberly and publicly with having been the cradle of the plantation, naming the foundation beneath the order.
- [W] Turn the island's industry and stability into prosperity shared across all who build it.
- [ ] Honour the resistance and dignity of the enslaved as the island's truer inheritance, not the order alone.
- [ ] Sustain the young republic as a nation making its own way, the pride and joy carried but never mistaken for the reckoning.
