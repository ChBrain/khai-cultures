...
It drives the island to speak in a voice at once the empire's and entirely its own. It is wielded whole by [Errol Barrow](persona_errol_barrow.md), the plain sharp English turned to declare the island free, by [Sir Garfield Sobers](persona_garfield_sobers.md), the everyday Bajan carried onto the world's cricket fields, and by [Grantley Adams](persona_grantley_adams.md), the parliamentary English turned to beat the empire at its own law. And it was forged from below by [Bussa](persona_bussa.md), whose own mother tongue was an African one, in the broken creole the enslaved built among themselves, and by [the cane cutter](persona_the_cane_cutter.md), from whose forged field-creole the island's Bajan grew. So the one tongue shows both who declared in it and who first made it.
