...
khai: play
title: "Arizona"
description: "Arizona staged: the Grand Canyon State of desert resilience, Navajo code talkers, and copper mining boomtowns."
declared: "Arizona"
language: en
...
Arizona, the Grand Canyon State in the Southwestern region of the United States. ISO US-AZ, language en.
...
- [Ramon](persona_ramon.md)
- [Yazhi](persona_yazhi.md)

**Places**

- [the Grand Canyon](place_grand_canyon.md)
- [Bisbee Mine](place_bisbee_mine.md)

**Processes**

- [copper smelting](process_copper_smelting.md)
- [navajo weaving](process_navajo_weaving.md)
...
- [copper ore](piece_copper_ore.md)
- [navajo rug](piece_navajo_rug.md)

**Pitches**

- [the Arizona key](pitch_arizona.md)

**An operational plan**

- [the groundwater plan](plan_groundwater_management.md)
...
**[Plot 2: The Code Talkers Contribution 1942](plot_02_code_talkers.md)**

Navajo marines develop an unbreakable military code using their native language, serving in critical Pacific theater campaigns.
