...
khai: play
title: "Minnesota"
description: "Minnesota staged: the Land of 10,000 Lakes of iron mining, Boundary Waters protection, and Minneapolis sound music."
declared: "Minnesota"
language: en
...
- [Lars](persona_lars.md)
- [Samantha](persona_samantha.md)

**Places**

- [the Boundary Waters](place_boundary_waters.md)
- [the Mesabi Range](place_mesabi_range.md)

**Processes**

- [medical device assembly](process_medical_device_assembly.md)
- [wilderness portage](process_wilderness_portage.md)
...
- [canvas canoe](piece_canvas_canoe.md)
- [pacemaker](piece_pacemaker.md)

**Pitches**

- [the Minnesota key](pitch_minnesota.md)

**An operational plan**

- [the Minnesota River plan](plan_minnesota_river_agricultural_runoff.md)
