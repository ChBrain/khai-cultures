...
The pitch [pitch_greenland.md](pitch_greenland.md) is written from Greenland's profile inflected by its harsh Arctic environment and hunting roots, and it names no dimension and carries no number.

| Dimension                     | Denmark base score (approx.) |
| ----------------------------- | ---------------------------- |
| Power Distance                | 18                           |
| Individualism                 | 74                           |
...
Source: Geert Hofstede, Hofstede Insights (the Country Comparison tool). Scores are approximate, as published by Hofstede Insights / The Culture Factor Group.
