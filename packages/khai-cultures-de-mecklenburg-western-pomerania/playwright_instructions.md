---
khai: instructions
title: "De Mecklenburg Western Pomerania"
...
# Instructions: De Mecklenburg Western Pomerania
...
- Declare `@chbrain/khai-cultures-de-mecklenburg-western-pomerania` as a dependency, then link `@chbrain/khai-cultures-de-mecklenburg-western-pomerania/position_culture_mecklenburgisch_vorpommersche_kultur.md` from the persona who belongs to it. A relative path resolves in a working tree
...
- This package is one culture staged as a full khai play: its own plots, its own
  cast, its own pitch, anchored by `de_mecklenburg_western_pomerania`'s play. You wire to its position,
