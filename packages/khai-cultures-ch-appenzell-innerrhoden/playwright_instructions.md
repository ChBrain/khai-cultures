---
khai: instructions
title: "Ch Appenzell Innerrhoden"
...
# Instructions: Ch Appenzell Innerrhoden
...
- Links `position_culture_der_halbkanton.md` from the persona that belongs here.
...
- The culture-position nests on `position_culture_schweizer_kultur.md`.

## System

- Depend on `@chbrain/khai-cultures-ch-appenzell-innerrhoden` and link by path from your content.
