...
- This group casts 3 member play(s): estonia, latvia, lithuania.
- The group is not counted in the house version; the minor is the culture count.

## System

- Depend on `@chbrain/khai-cultures-baltics` and link by specifier from your content.
