...
- Links `position_culture_la_republique.md` from the persona that belongs here.
...
- Depend on `@chbrain/khai-cultures-ch-neuchatel` and link by path from your content.
