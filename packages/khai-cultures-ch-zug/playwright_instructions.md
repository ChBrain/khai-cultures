...
- Links `position_culture_das_steuerparadies.md` from the persona that belongs here.
...
- Depend on `@chbrain/khai-cultures-ch-zug` and link by path from your content.
