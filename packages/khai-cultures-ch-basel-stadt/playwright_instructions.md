...
- Links `position_culture_basler_kultur.md` from the persona that belongs here.
...
- The culture-position nests on `position_culture_schweizer_kultur.md`: being
  Basler is a way of being Swiss.

## System

- Depend on `@chbrain/khai-cultures-ch-basel-stadt` and link by path from your content.
