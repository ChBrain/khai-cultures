...
(`management/design/cultures-as-packages.md`) reaches them. **27 landed.**
...
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------- |
| `bar/position_language_bar.md`     | Bavarian, its own Upper German dialect family, written in Bavarian                                                   | `bar`    |
