...
(`management/design/cultures-as-packages.md`) reaches them. **26 landed.**
...
| `de/position_language_de_de_by.md` | ?                                                                                                                    | `de`     |
...
| `de/position_language_de_de_he.md` | ?                                                                                                                    | `de`     |
...
| `de/position_language_de_de_st.md` | ?                                                                                                                    | `de`     |
