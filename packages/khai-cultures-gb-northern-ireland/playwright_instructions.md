...
# Instructions: Gb Northern Ireland
...
- Declare `@chbrain/khai-cultures-gb-northern-ireland` as a dependency, then link `@chbrain/khai-cultures-gb-northern-ireland/position_culture_northern_irish_culture.md` from the persona who belongs to it. A relative path resolves in a working tree
...
- This package is one culture staged as a full khai play: its own plots, its own
  cast, its own pitch, anchored by `gb_northern_ireland`'s play. You wire to its position,
