...
- This group casts 4 member play(s): gb_england, gb_northern_ireland, gb_scotland, gb_wales.
- The group is not counted in the house version; the minor is the culture count.

## System

- Depend on `@chbrain/khai-cultures-the-four-nations` and link by specifier from your content.
