---
khai: plot
title: "the refugees and the factories"
declared: "the refugees and the factories"
language: en
...
# Plot: the refugees and the factories

## Taxonomy

[play_hong_kong](play_hong_kong.md)
...
The mid-twentieth century convulses the mainland, civil war, then revolution, then the campaigns that follow, and wave after wave of people cross the border into the colony with little more than what they can carry. The population swells far beyond anything the small territory was built to hold. Squatter towns climb the hillsides in tin and timber, fires and floods sweep through them, and the government answers, slowly and then in earnest, with resettlement estates stacked block upon block. Out of that crowded, improvised city a different economy has to be built almost from nothing.
...
A city crowded past its limits by people who own nothing and expect to stay only until the next boat has, instead, to become someone's permanent home, and it has only its own hands to build that home with. Whether the squatter towns become factories or only stay squatter towns, whether the hustle wins out over the hardship, is not decided in any office; it is decided estate by estate, workshop by workshop, in a single crowded generation with no other way out but through.
