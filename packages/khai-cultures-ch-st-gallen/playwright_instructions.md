...
- Links `position_culture_der_ringkanton.md` from the persona that belongs here.
...
- Depend on `@chbrain/khai-cultures-ch-st-gallen` and link by path from your content.
