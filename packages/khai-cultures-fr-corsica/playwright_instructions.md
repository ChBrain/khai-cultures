...
- The culture-position nests on `@chbrain/khai-cultures-france/position_culture_*.md`.

## System

- Depend on `@chbrain/khai-cultures-fr-corsica` and link by path from your content.
