...
- This group casts 4 member play(s): czechia, hungary, poland, slovakia.
- The group is not counted in the house version; the minor is the culture count.

## System

- Depend on `@chbrain/khai-cultures-visegrad` and link by specifier from your content.
