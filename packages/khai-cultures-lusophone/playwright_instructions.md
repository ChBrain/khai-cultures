...
- This group casts 2 member play(s): brazil, portugal.
- The group is not counted in the house version; the minor is the culture count.

## System

- Depend on `@chbrain/khai-cultures-lusophone` and link by specifier from your content.
