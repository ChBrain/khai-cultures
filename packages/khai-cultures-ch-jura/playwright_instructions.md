...
- Links `position_culture_la_rebellion_identitaire.md` from the persona that belongs here.
...
- Depend on `@chbrain/khai-cultures-ch-jura` and link by path from your content.
