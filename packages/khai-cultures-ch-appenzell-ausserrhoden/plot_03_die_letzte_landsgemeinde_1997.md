---
khai: plot
title: "Plot: Die letzte Landsgemeinde 1997"
declared: "Die letzte Landsgemeinde 1997"
language: de
...
# Plot: Die letzte Landsgemeinde 1997

## Taxonomy

Die Selbstabschaffung durch Handmehr.
...
- `place`: [Der Landsgemeindeplatz Trogen](place_der_landsgemeindeplatz_trogen.md)
- `position`: [Die Ausserrhoder Kultur](position_culture_die_ausserrhoder_kultur.md)
- `persona`: [Der Fabrikant](persona_der_fabrikant.md)
