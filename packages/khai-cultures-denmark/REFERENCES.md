...
| Dimension                     | Denmark score (approx.) |
| ----------------------------- | ----------------------- |
| Power Distance                | 18                      |
| Individualism                 | 74                      |
| Motivation toward Achievement | 16                      |
...
between the older welfare-state generation (thrift, modesty, hygge) and the
younger, connected one (cycling, design, the open world).
