...
khai: play
title: "Belgium"
description: "Belgium staged as a culture: a country with no common tongue, held across its language border."
declared: "la Belgique"
language: fr
...
La Belgique, petit royaume d'Europe occidentale né en 1830, coincé entre la France, l'Allemagne, les Pays-Bas et la mer du Nord, et siège de l'Union européenne. ISO BE, trois langues officielles : le néerlandais au nord, le français au sud, l'allemand à l'est.
...
- [Albert Ier](persona_albert_ier.md)
- [Hendrik Conscience](persona_conscience.md)
- [Julien](persona_julien.md)
- [Wout](persona_wout.md)
- [Naïma](persona_naima.md)

**Places**

- [Bruxelles](place_bruxelles.md)
- [l'Yser](place_yser.md)

**Processes**

- [le carnaval](process_le_carnaval.md)
- [la table](process_la_table.md)
...
- [le français de Belgique](@chbrain/khai-cultures-tongues/fr/position_language_fr_be.md)
- [het Belgisch Nederlands](@chbrain/khai-cultures-tongues/nl/position_language_nl_be.md)

**Pieces**

- [les frites](piece_les_frites.md)
- [la pipe de Magritte](piece_la_pipe_de_magritte.md)

**Pitches**

- [le ton belge](pitch_be.md)

**Plans**

- [tenir le pays ensemble](plan_tenir_le_pays_ensemble.md)
...
**[Plot 2 : L'Yser, 1914](plot_02_yser_1914.md)**

[Albert Ier](persona_albert_ier.md) tient le dernier coin du pays derrière [l'Yser](place_yser.md) ; l'inégalité des langues au front, des soldats flamands sous des ordres français, nourrit le Mouvement flamand né du déséquilibre de 1830.

**[Plot 3 : La frontière linguistique, 1962](plot_03_frontiere_linguistique_1962.md)**

Pour apaiser cette revendication, les lois de 1962-63 fixent [la frontière linguistique](position_la_frontiere_linguistique.md) en travers du pays et attachent la langue au territoire, ouvrant la route de la fédéralisation.
...
Savoir si un pays sans langue commune, né d'un déséquilibre et traversé d'une frontière au milieu de ses propres mots, peut tenir ensemble par le compromis, la Couronne et l'absurde, ou s'il finira par se défaire, en paix, en deux nations qui ne se parlaient déjà plus qu'en anglais.
