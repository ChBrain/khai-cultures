...
# Instructions: Ch Basel Landschaft
...
- Links `position_culture_baselbieter_kultur.md` from the persona that belongs here.
...
- The culture-position nests on `position_culture_schweizer_kultur.md`: being
  Baselbieter is a way of being Swiss.

## System

- Depend on `@chbrain/khai-cultures-ch-basel-landschaft` and link by path from your content.
