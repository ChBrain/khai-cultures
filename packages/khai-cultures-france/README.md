# France: a khai culture

France staged as a full khai play, ISO FR, language fr. A large country built by
the state and by an idea as a theatre: its history as the plot line, its people
as the cast, the roles its language encodes, its places, its practices, and its
...
- **Pieces:** Marianne (the figure of the Republic), la baguette (everyday
  France).
