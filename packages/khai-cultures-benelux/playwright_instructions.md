...
- This group casts 3 member play(s): belgium, luxembourg, netherlands.
- The group is not counted in the house version; the minor is the culture count.

## System

- Depend on `@chbrain/khai-cultures-benelux` and link by specifier from your content.
