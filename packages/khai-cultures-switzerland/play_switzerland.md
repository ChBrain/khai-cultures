...
khai: play
title: "Switzerland"
description: "Switzerland staged as a culture: a nation made by will, holding four languages together as one."
declared: "Schweiz"
language: de
...
Die Schweiz, Confoederatio Helvetica, das Alpenland im Herzen Europas, viersprachig und föderal. ISO CH, Sprachen de, fr, it, rm.

## Arc

Ein kleines Land mitten in Europa, das nicht durch eine Sprache, ein Volk oder einen Glauben zusammenhält, sondern durch den Willen, eines zu sein. Vier Sprachen, sechsundzwanzig Kantone, Katholiken und Protestanten, Berg und Stadt, gebunden durch Föderalismus, direkte Demokratie und die Konkordanz, in der die Gegner gemeinsam regieren. Aus Misstrauen gegen jede grosse Macht und aus Neutralität nach aussen wächst ein Sonderfall, der sich aus eigener Kraft und mit grosser Geduld selbst verwaltet. Unter dem Wohlstand liegt die stille Frage, ob der Wille zur Einheit hält, wenn die Sprachen auseinanderstreben.
...
- [Huldrych Zwingli](persona_zwingli.md)
- [Jean Calvin](persona_calvin.md)
- [Guillaume-Henri Dufour](persona_dufour.md)
- [Henry Dunant](persona_dunant.md)
- [Henri Guisan](persona_guisan.md)
- [Philipp Etter](persona_etter.md)
- [der Säumer](persona_saeumer.md)
...
- [Bern](place_bern.md)
- [Genf](place_genf.md)
- [der Gotthard](place_gotthard.md)
- [Zürich](place_zuerich.md)
- [die Surselva](place_surselva.md)
- [das Tessin](place_ticino.md)
- [das Réduit](place_reduit.md)

**Processes**

- [die Volksabstimmung](process_volksabstimmung.md)
- [das Jassen](process_jassen.md)
...
- [der Konfessionsfrieden](position_konfessionsfriede.md)
- [das Bankgeheimnis](position_bankgeheimnis.md)
- [das Schweizer Hochdeutsch](@chbrain/khai-cultures-tongues/de/position_language_de_ch.md)
- [das Schwiizerdütsch](@chbrain/khai-cultures-tongues/gsw/position_language_gsw.md)
...
- [das Taschenmesser](piece_taschenmesser.md)
- [das Fondue](piece_fondue.md)
- [die Uhr](piece_uhr.md)
...
Ob ein Land, das nicht durch Sprache oder Blut, sondern allein durch den Willen zusammenhält, seine Einheit über vier Sprachen und sechsundzwanzig Kantone hinweg bewahrt, wenn Wohlstand, Tempo und die Welt draussen die geduldige Konkordanz auf die Probe stellen.
