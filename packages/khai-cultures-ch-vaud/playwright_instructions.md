...
- Links `position_culture_la_romandie.md` from the persona that belongs here.
...
- Depend on `@chbrain/khai-cultures-ch-vaud` and link by path from your content.
