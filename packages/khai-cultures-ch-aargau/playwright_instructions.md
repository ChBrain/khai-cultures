...
- Links `position_culture_aargauer_kultur.md` from the persona that belongs here.
...
- The culture-position nests on `position_culture_schweizer_kultur.md`: being
  Aargauer is a way of being Swiss.

## System

- Depend on `@chbrain/khai-cultures-ch-aargau` and link by path from your content.
