---
khai: instructions
title: "De North Rhine Westphalia"
...
# Instructions: De North Rhine Westphalia
...
- Declare `@chbrain/khai-cultures-de-north-rhine-westphalia` as a dependency, then link `@chbrain/khai-cultures-de-north-rhine-westphalia/position_culture_nordrhein_westfaelische_kultur.md` from the persona who belongs to it. A relative path resolves in a working tree
...
- This package is one culture staged as a full khai play: its own plots, its own
  cast, its own pitch, anchored by `de_north_rhine_westphalia`'s play. You wire to its position,
