...
cultural sources behind the plots, personas, places, and pieces.
...
| Motivation / Success  | Modest display, cooperation over open competition; quiet endurance over striving.     |
| Uncertainty Avoidance | Relaxed: the unhurried "leve-leve," living in the island's own time.                  |
| Long-Term Orientation | Present-focused; making a feast of what there is today.                               |
...
claimed; the staging is original work. The slave and forced-labour plantation
past is staged soberly on the public record, with dignity, with no atrocity
detail, and with no political side taken.
