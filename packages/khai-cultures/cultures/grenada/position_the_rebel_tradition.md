---
khai: position
title: "the rebel tradition"
declared: "the rebel tradition"
language: en
...
That resistance is right there in the island marrow, that to be Grenadian is to have inherit both the rebellion of 1795 and the federation dream that come after it; that a small place can refuse the terms it is given and imagine a bigger belonging; and that the rebel and the statesman, the rising and the vision, are two motions of the one same long tradition.

## Loses

Ground when the tradition turn from principle into strife alone, when refusal forget the vision that should give it shape; and ground too to the discouragement of the small, the feeling that an island so little cannot in the end stand against the weight of the wide world, and had best keep its head down and take what it is given.
