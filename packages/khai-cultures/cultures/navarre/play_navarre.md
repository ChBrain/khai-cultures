...
khai: play
title: "Navarra"
description: "Navarra representada: los hayedos de la selva de Irati, los encierros de Pamplona y los espárragos de la Ribera."
declared: "Navarra"
language: es
...
Navarra, comunidad foral y nacionalidad histórica del norte de España. ISO ES-NC, lengua es, con el euskera en el reparto.
...
- [Fermin](persona_fermin.md)
- [Ane](persona_ane.md)

**Places**

- [la selva de Irati](place_irati_forest.md)
- [la calle Estafeta](place_estafeta_street.md)

**Processes**

- [el pelado de espárragos](process_asparagus_peeling.md)
- [el encierro de toros](process_bull_running.md)
...
- [el pañuelico de San Fermín](piece_red_pamplona_scarf.md)
- [la vara de haya](piece_beechwood_she_stick.md)

**Pitches**

- [el tono navarro](pitch_navarre.md)

**Un plan operativo**

- [el plan del hayedo](plan_irati_forest_conservation.md)
...
**[Plot 2: Fiesta y Encierro 1926](plot_02_san_fermin.md)**

La novela de Hemingway difunde internacionalmente los encierros y la feria taurina de los sanfermines de Pamplona.
...
Si una comunidad foral con fuerte división identitaria entre sus valles del norte euskaldunes y su Ribera de secano puede consolidar la conservación de sus recursos hídricos y forestales.
