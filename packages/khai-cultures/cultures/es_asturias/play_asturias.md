...
khai: play
title: "Asturias"
description: "Asturias representada: las cumbres de los Picos de Europa, el escanciado de sidra y las cuencas mineras de carbón."
declared: "Asturias"
language: es
...
Asturias, comunidad autónoma y nacionalidad histórica del norte de España. ISO ES-AS, lengua es, con el asturiano en el reparto.
...
- [Covadonga](persona_covadonga.md)
- [Xuan](persona_xuan.md)

**Places**

- [el santuario de Covadonga](place_covadonga_sanctuary.md)
- [los Picos de Europa](place_picos_de_europa.md)

**Processes**

- [el escanciado de sidra](process_cider_pouring.md)
- [la maduración de Cabrales](process_cabrales_aging.md)

**Positions**

- [la montaña cantábrica](position_cantabrian_mountain.md)
- [el asturiano](position_asturian_language.md)
- [el español de Asturias](@chbrain/khai-cultures-tongues/es/position_language_es_es_as.md)
- [la cultura asturiana](position_culture_cultura_asturiana.md)

**Pieces**

- [el vaso de sidra](piece_cider_glass.md)
- [la lámpara de mina](piece_miner_lamp.md)

**Pitches**

- [el tono asturiano](pitch_asturias.md)

**Un plan operativo**

- [el plan del oso pardo](plan_cantabrian_bear_conservation.md)
...
**[Plot 2: La Revolución de Octubre 1934](plot_02_miners.md)**

Los mineros del carbón de las cuencas del Nalón y el Caudal protagonizan un levantamiento armado en defensa de los derechos obreros.
