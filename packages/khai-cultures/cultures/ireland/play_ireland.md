...
khai: play
title: "Ireland"
description: "Ireland staged as a culture: a nation that reveres a first language it barely speaks and lives in English."
declared: "Éire"
language: en
...
[khai-cultures](https://github.com/ChBrain/khai-cultures): the Cultures house that holds this production and answers for it. This culture logs the house as its Estate; a culture with no Estate is not yet a production.
...
- [Pádraig Pearse](persona_pearse.md)
- [James Joyce](persona_joyce.md)
- [Bríd](persona_brid.md)
- [Cian](persona_cian.md)
- [Mary](persona_mary.md)

**Places**

- [Dublin](place_dublin.md)
- [an Ghaeltacht](place_an_ghaeltacht.md)

**Processes**

- [an seisiún](process_an_seisiun.md)
- [the GAA](process_the_gaa.md)
...
- [the harp](piece_the_harp.md)
- [the pint](piece_the_pint.md)

**Pitches**

- [the Irish tone](pitch_ie.md)

**Plans**

- [athbheochan na Gaeilge](plan_athbheochan_na_gaeilge.md)
