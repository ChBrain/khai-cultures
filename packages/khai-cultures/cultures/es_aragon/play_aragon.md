...
khai: play
title: "Aragón"
description: "Aragón representado: las cumbres del Pirineo, la jota en la plaza del Pilar y el pastoreo de las tierras secas."
declared: "Aragón"
language: es
...
Aragón, comunidad autónoma y nacionalidad histórica del norte de España. ISO ES-AR, lengua es, con el aragonés pirenaico en el reparto.
...
- [Javier](persona_javier.md)
- [Piluca](persona_piluca.md)

**Places**

- [el Pirineo](place_pyrenees.md)
- [el Pilar](place_pilar.md)

**Processes**

- [el baile de la jota](process_jota_dancing.md)
- [el asado de ternasco](process_mutton_roasting.md)
...
- [el español de Aragón](@chbrain/khai-cultures-tongues/es/position_language_es_es_ar.md)

**Pieces**

- [las castañuelas de jota](piece_jota_castanets.md)
- [el cayado de pastor](piece_pyrenean_shepherd_staff.md)

**Pitches**

- [el tono aragonés](pitch_aragon.md)

**Un plan operativo**

- [el plan del Pirineo](plan_pyrenees_ecosystem_conservation.md)
...
**[Plot 2: Los Sitios de Zaragoza 1808](plot_02_zaragoza.md)**

Los ciudadanos de Zaragoza resisten dos duros asedios de las tropas de Napoleón, convirtiendo la ciudad en símbolo.
