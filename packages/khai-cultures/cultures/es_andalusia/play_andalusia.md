...
khai: play
title: "Andalucía"
description: "Andalucía representada: los infinitos olivos de Jaén, el cante jondo del tablao y el orgullo del jornalero rural."
declared: "Andalucía"
language: es
...
Andalucía, comunidad autónoma y nacionalidad histórica del sur de España. ISO ES-AN, lengua es, con su habla regional de andaluz en el reparto.
...
- [Manuel](persona_manuel.md)
- [Rocío](persona_rocio.md)

**Places**

- [el olivar](place_olive_grove.md)
- [el tablao](place_tablao.md)

**Processes**

- [el prensado de aceituna](process_olive_pressing.md)
- [el cante jondo](process_cante_jondo.md)

**Positions**

- [el andalucismo](position_culture_andalucismo.md)
- [el jornalismo](position_jornalero_solidarity.md)
- [el arte flamenco](position_flamenco_art.md)
- [el español andaluz](@chbrain/khai-cultures-tongues/es/position_language_es_es_an.md)

**Pieces**

- [las castañuelas](piece_castanets.md)
- [la orza de aceite](piece_olive_jar.md)

**Pitches**

- [el tono andaluz](pitch_andalusia.md)

**Un plan operativo**

- [el plan de riego del Guadalquivir](plan_guadalquivir_irrigation_control.md)
...
**[Plot 2: La Reforma Agraria 1932](plot_02_land_reform.md)**

Los jornaleros del campo exigen el reparto de las grandes fincas terratenientes, desatando ocupaciones y represión.
