---
khai: position
title: "Northern Irish Culture"
declared: "Northern Irish culture"
language: en
...
# Position: Northern Irish culture
...
That a name, a street sign, a greeting be read as a flag before it is heard as speech, so that even the name of the second city cannot be said without choosing a side. Yet since 1998 it orders the harder discipline of parity of esteem: that power be shared, that change come only by consent, and that each community grant the other the dignity it claims for itself, a daily, deliberate choice to keep faith with the settlement rather than the easier comfort of standing apart.
...
It drove two rival traditions to sit down together after three decades of grief and to make, at last, the harder settlement neither could have made alone, carried jointly by leaders from both sides of the divide. It drives the province still to ask, in every generation, whether the wee country can be home to both traditions at once, and it carries its people to keep faith with the peace daily rather than to let the difference fall back into the gun. Its English, [Northern Irish English](@chbrain/khai-cultures-tongues/en/position_language_en_gb_nir.md), is the common ground both traditions actually speak, even where the heritage tongues are claimed as separate flags.
