...
Tema vaikne truudus võib jäätuda umbusuks kõige uue ja võõra vastu: hoiab oma keelt ja oma metsa nii kõvasti, et ei tunne enam lapselapsi, kes elavad ekraanil ja inglise keeles, ja näeb maailmas vaid kaotust.

## Tell

Vastab igale rõõmule vaikse "eks näe", mõõdab aega laulupidude ja aastaaegade järgi, ja mäletab paremini neid, kelle Siber või võõrsi võttis, kui neid, kes jäid.
