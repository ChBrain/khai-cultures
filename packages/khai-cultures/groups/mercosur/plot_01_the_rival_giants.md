---
khai: plot
title: "the Rival Giants"
declared: "the Rival Giants"
language: en
...
Two great powers rise on either side of the Rio de la Plata basin, heirs to the rival crowns of Spain and Portugal, and for more than a century they contend for mastery of the south. The lands between them, and the rivers that run through, become the stakes of a long, wary rivalry.
...
The whole grouping begins as a rivalry, not a friendship: the two giants that would one day found a common market spent more than a century arming against each other and twice came near to war. The old asymmetry between the giants and the small nations of the basin, and the suspicion bred by that long contest, are written into the bloc from the start, the imbalance the later union would have to overcome and never fully would.
