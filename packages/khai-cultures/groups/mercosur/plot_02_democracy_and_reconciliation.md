---
khai: plot
title: "Democracy and Reconciliation"
declared: "Democracy and Reconciliation"
language: en
...
# Plot: Democracy and Reconciliation
...
The long night of military rule across the Southern Cone ends, and civilian government returns to the giants in the 1980s. With the generals gone, the two great rivals find, for the first time, a reason and a freedom to reach toward each other instead of arming against one another.
...
The reconciliation that made the bloc possible came only after a period of military rule across the Southern Cone, a fact of the public record named here soberly and without taking any side. The bloc is founded on a deliberate turning away from a century of rivalry, and the same return of democracy that made the union possible carries within it the memory of how recently the south had been governed otherwise, a memory each member nation reckons with in its own history.
